...
using Soenneker.Apollo.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Apollo.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Apollo:ClientGenerationUrl"] ?? "https://docs.apollo.io/openapi/apollo-rest-api.json";
        ...
        if (filePath == null)
            throw new InvalidOperationException("Apollo OpenAPI document download failed.");
        ...
        await _kiotaUtil.Generate(fixedFilePath, "ApolloOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
